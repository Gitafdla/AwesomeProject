...
const Createdata = () => {
    const jsonUrl = 'http://10.0.2.2:3000/mahasiswa'; //API yg digunakan emulator untuk akses localhost komputer
    const [first_name, setFirstName] = useState(''); //UseState untuk menyimpan data
